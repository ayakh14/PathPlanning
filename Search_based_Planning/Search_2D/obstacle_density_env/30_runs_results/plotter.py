...
for metric in metrics:
    ...
    plt.yscale('log')
    plt.legend()
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_vs_Obstacle_Density_line_plot_30_run.png"))
    plt.close()
...
for metric in metrics:
    ...
    plt.grid(True)
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_vs_Obstacle_Density_error_bar_plot_30_run.png"))
    plt.close()
...
#     plt.legend()
#     plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_vs_Obstacle_Density_bar_plot_30_run.png"))
#     plt.close()
...
for metric in metrics:
    ...
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_Distribution_box_plot_30_run.png"))
    plt.close()
