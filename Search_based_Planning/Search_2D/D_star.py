...
def main():
    ...
    result_files = ['grid_size_env/results/D_star_results.csv', 'start_goal_distance_env/results/D_star_results.csv', 'obstacle_density_env/results/D_star_results.csv']
