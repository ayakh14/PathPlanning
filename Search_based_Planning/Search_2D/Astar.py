...
# from specific_env import load_specific_environments
import csv
# from another_specific_env import load_environments_1, plot_environment_1
...
def process_env(env_loader, directory, result_file):
    ...
    with open(result_file, 'w', newline='') as file:
        ...
        for i, env in enumerate(envs):          
            ...
            for exp in range(10):
                #add the following         https://stackoverflow.com/questions/1316767/how-can-i-explicitly-free-memory-in-python
                # after each process try clear
                s_start = env.start
                s_goal = env.goal        
                ...
                writer.writerow([exp, i+1, env.obs_density, env.x_range , env.manhattan_distance, "-", total_path_cost, total_expanded_nodes, astar.total_searches, memory_consumption, execution_time])
...
def main():
    ...
    result_files = ['grid_size_env/results/A_star_results.csv', 'start_goal_distance_env/results/A_star_results.csv', 'obstacle_density_env/results/A_star_results.csv']
