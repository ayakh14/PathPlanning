...
for metric in metrics:
    ...
    plt.yscale('log')
    plt.legend()
    plt.savefig(os.path.join(save_dir,f"{metric}_vs_sg_distance_line_plot_100_run.png"))
    plt.close()
...
for metric in metrics:
    ...
    plt.grid(True)
    plt.savefig(os.path.join(save_dir, f"{metric}_vs_sg_distance__error_bar_plot_100_run.png"))
    plt.close()
...
#     plt.legend()
#     plt.savefig(os.path.join(save_dir, f"{metric}_vs_sg_distance_bar_plot_100_run.png"))
#     plt.close()
...
#     plt.savefig(os.path.join(save_dir, f"{metric}_vs_sg_distance_box_plot_100_run.png"))
#     plt.close()
...
#     plt.legend()
#     plt.savefig(os.path.join(save_dir, f"{metric}_vs_sg_distance_box_plot_with_points_100_run.png"))
#     plt.close()
