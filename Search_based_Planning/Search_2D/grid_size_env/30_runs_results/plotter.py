...
for metric in metrics:
    ...
    plt.yscale('log')
    plt.legend()
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_vs_Grid_Size_line_plot_30_run.png"))  # Save the plot as png
    plt.close()
...
for metric in metrics:
    ...
    plt.grid(True)
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_vs_Grid_Size_error_bar_plot_30_run.png"))  # Save the plot as png
    plt.close()
...
for metric in metrics:
    ...
    plt.legend()
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_vs_Grid_Size_bar_plot_30_run.png"))  # Save the plot as png
    plt.close()
...
for metric in metrics:
    ...
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_Distribution_box_plot_30_run.png"))  # Save the plot as png
    plt.close()
...
for metric in metrics:
    ...
    plt.legend()
    plt.savefig(os.path.join(save_dir, f"{metric.replace(' ', '_')}_Boxplot_for_Each_Algorithm_30_run.png"))  # Save the plot as png
    plt.close()
